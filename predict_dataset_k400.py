...
class PredictDataset(data.Dataset):
    def __init__(self, root, mode="train", dataset="UCF101", args=None):
...
#             transforms.RandomCrop(112),
        ...
        print('motion attention mode:{}'.format(self.MA_mode))
        print("totalnum:",len(self.list))
...
if __name__ == '__main__':
    ...
    com = PredictDataset('/home/cat/Workspace/Dataset/UCF-101-origin', mode="train", args=args);
    train_dataloader = DataLoader(com, batch_size=8, num_workers=4, shuffle=True, drop_last=True)
    for i, (sample_clip, recon_clip, sample_step_label, recon_rate, patch_loss_mask,recon_flags,recon_step_label) in enumerate(train_dataloader):
        print(i)
        print(sample_clip.size())
        print(recon_clip.size())
        print(sample_step_label)
        print(recon_step_label)
        print(recon_flags.size())
        # print(a.size())
        # print(b.size())
        # print(a)
        # print(b)
