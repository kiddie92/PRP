...
def main():
    ...
    train_loader = DataLoader(train_dataset,sampler=train_sampler,batch_size=params['batch_size'],num_workers=params['num_workers'],drop_last=True)
    ...
    val_dataset = DistributedSampler(val_dataset,num_replicas=hvd.size(),rank=hvd.rank())
    val_loader = DataLoader(val_dataset,sampler=train_sampler,batch_size=params['batch_size'],num_workers=params['num_workers'],drop_last=True)
